...
def transfer():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        transferee_userid = Account.query.filter_by(acc_number=transferee_acc_number).first().id
        ...
        createTransaction(amount, transferrer_id, transferee_id, require_approval)
