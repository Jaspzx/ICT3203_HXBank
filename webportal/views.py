...
def register():
	...
	if request.method == 'POST' and form.validate_on_submit():
		...
		message_add(welcome_msg(welcome_amt), user.id)
		add_db(new_account)
...
def transfer():
	...
	if request.method == 'POST' and form.validate_on_submit():
		...
		new_transaction = Transaction(amount, transferer_acc_number, transferee_acc_number, description, require_approval)
